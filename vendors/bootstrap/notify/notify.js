function notify(type, title, message) {
    ...
    switch (toast_type) {
        ...
        case 'spinner':
            ...
            break;
        case 'whatsapp':
            toast_icon = '<i style="width:35px;height:35px" class="fab fa-2x fa-whatsapp"></i>';
            break;
        case 'facebook-messenger':
            toast_icon = '<i style="width:35px;height:35px" class="fab fa-2x fa-facebook-messenger"></i>';
            break;
        case 'chating':
            toast_icon = '<i style="width:35px;height:35px" class="fas fa-2x fa-comments"></i>';
            break;
            //DEFAULT
        default:
