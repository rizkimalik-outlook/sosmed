var SoundControl = function () {
    ...
    me = this;
    //Init sounds
    me.registerSound = me.initSound("dist/sounds/REGISTER.mp3", false, "auto");
    me.messageSound = me.initSound("dist/sounds/MESSAGE.mp3", false, "auto");
    me.ringSound = me.initSound("dist/sounds/CALL_OUT.mp3", true, "none");
    me.busySound = me.initSound("dist/sounds/BUSY.mp3", false, "none");
    me.finishSound = me.initSound("dist/sounds/HANGUP.mp3", false, "none");
};
